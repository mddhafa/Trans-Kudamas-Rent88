...
${formData.pesan}`;
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="contact-header-section bg-gradient-to-r from-primary to-primary/90 text-white py-16 px-6">
          ...
          >
            <div className="text-center space-y-4">
              ...
              <div className="space-y-4 text-sm text-[#526176]">
                <div>
                  <p className="font-medium text-[#1e293b] mb-1">Jabodetabek</p>
                  <p>Jl. Sudirman No. 123</p>
                  <p>Jakarta Pusat 10220</p>
                </div>
                <div>
                  <p className="font-medium text-[#1e293b] mb-1">Yogyakarta</p>
                  <p>Jl. Malioboro No. 45</p>
            ...
            <div className="text-center space-y-4">
              ...
              <div className="flex justify-center gap-4 pt-2">
                {/* <a
                  ...
                  className="w-12 h-12 bg-secondary rounded-full flex items-center justify-center hover:bg-gold hover:text-white transition-all hover:scale-110"
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 text-gold rounded-full flex items-center justify-center hover:bg-gold hover:text-primary-foreground hover:scale-110 transition-all"
                aria-label="Tiktok"
              >
              ...
              <a
                ...
                aria-label="Instagram"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="purple">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 text-gold rounded-full flex items-center justify-center hover:bg-gold hover:text-white transition-all hover:scale-110"
                  aria-label="WhatsApp"
                >
