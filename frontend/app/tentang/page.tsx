...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="about-header-section relative pt-20 pb-10 px-6 bg-gradient-to-br from-primary via-primary/95 to-primary/90 text-white overflow-hidden">
          ...
          <motion.div className="mb-32" {...fadeInUp}>
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Mengapa memilih Trans Kudamas 88 sebagai mitra perjalanan Anda
              </p>
            </div>
    ...
    <div className="relative z-10 grid lg:grid-cols-2 gap-10 md:gap-14 items-center">
      ...
      <div className="space-y-6 text-white">
        ...
        <p className="text-sm sm:text-base md:text-lg text-white/80 leading-relaxed max-w-2xl">
          Trans Kudamas 88 melayani kebutuhan transportasi profesional untuk perjalanan bisnis, wisata, dan kebutuhan operasional di berbagai kota besar seluruh Pulau Jawa dengan armada premium dan sopir profesional.
        </p>
